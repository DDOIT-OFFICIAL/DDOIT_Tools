...
|---|---|
| Unity | 6000.3.7f1 |
| Meta XR All-In-One SDK | 203.0.0 (Audio/Voice 모듈만 v85.0.0 유지) |
| Meta XR Movement SDK | 203.0.0 (현재 GitHub main HEAD 잠금, 재현성 필요 시 `#v203.0.0` 검토, Min Unity 6 강제) |
| XR Management | 4.5.4 |
| OpenXR | 1.17.1 |
| Addressables | 2.8.1 |
| URP | 17.3.0 |
